...
const Dashboard: React.FC = () => {
  ...
  // Componente encapsulado para cards de administrador
  const AdminCards = () => {
    return (
      <>
        {/* Card 3: Approvals */}
  ...
  // Componente encapsulado para o resumo estatístico
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <ErrorBoundaryWrapper componentName="DebugInfo">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Admin Cards */}
        {isAdmin && (
          <ErrorBoundaryWrapper componentName="AdminCards">
            <AdminCards />
          </ErrorBoundaryWrapper>
        )}
      </div>
      ...
      {/* Statistics Summary */}
      {isAdmin && (
        <ErrorBoundaryWrapper componentName="StatisticsSummary">
          <StatisticsSummary />
        </ErrorBoundaryWrapper>
      )}
    </div>
